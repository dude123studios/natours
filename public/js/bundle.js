...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateUserSettings.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/".concat(type === 'data' ? 'update-me' : 'update-password'),
              data: settings
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updated Successfully")); //location.reload();
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHVkZTEyM3N0dWRpb3MiLCJhIjoiY2tybWYwODFuN3RwNjJubDNneTA3Y2FxZCJ9.3ow6D5912TvP9Z9w9xn0yw';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_RiH6EKtDNxSUbPIbm8booxK500yRWUeBdy'); // <==== PUT THE VARIABLE HERE
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateUserSettings.updateSettings)(form, 'data');
  });
}
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    (0, _updateUserSettings.updateSettings)({
      password: password,
    ...
    document.getElementById('password').value = '', _readOnlyError("password");
  });
}
